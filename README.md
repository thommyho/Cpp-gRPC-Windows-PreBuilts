...
- **Stable build**: [v1.74.1](https://github.com/grpc/grpc/releases/tag/v1.74.1)

Visit the release page to download the binaries ➡️ [here](https://github.com/thommyho/gRPC_windows/releases/v1.74.1) ⬅️.
