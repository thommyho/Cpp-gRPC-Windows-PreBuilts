...
| **[1.66.2](https://github.com/thommyho/gRPC_windows/releases/tag/v1.66.2) (:octicons-heart-fill-24:{ .heart } latest)** | **[link](https://github.com/thommyho/gRPC_windows_prebuilt/tree/v1.66.2)** | :material-check-decagram:{ .tick-blue } | :material-check-decagram:{ .tick-blue } |
