...
| :----------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------: | :-------------------------------------: | :-------------------------------------: |
| **[1.43.2 ](https://github.com/thommyho/gRPC_windows/releases/tag/v1.43.2) (:octicons-heart-fill-24:{ .heart } latest)** | **[link](https://github.com/thommyho/gRPC_windows_prebuilt/tree/v1.43.2)** | :material-check-decagram:{ .tick-blue } | :material-check-decagram:{ .tick-blue } |
...
!!! warning "So far all releases had been successfully built and tested against all three compiler, but this might change in the future - especially for the older 2015 version."
