...
2. **Release Version Table**: Check the available versions in the [release version table](steps.md#download).
...
- Check the [setup instructions](steps.md) for detailed installation steps
